...
class OrderSystemPrototypeTest {
	...
	public void setupScenary2() {
		osp.registerProduct("Chocolate", "very delicious dessert",4.0, "12345");
		osp.registerProduct("Juice", "very delicious drink",3.0, "123454");
		osp.registerProduct("Apple", "very delicious fruit",2.0, "123245");
		osp.registerProduct("Doritos", "very delicious chips",2.5, "123545");
		code = osp.getProducts().get(3).getCode();
	...
	void updateProdDataTest() {
		...
		osp.updateProdData(code, "Beer", "Delicious drink", 3.0, "12351");
		assertEquals(code, osp.getProducts().get(3).getCode());
